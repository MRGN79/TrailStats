...
- **Soporte multi-plataforma — Apple Health y Polar Flow:** TrailStats detecta ahora automáticamente el origen del export y lo procesa con el parser correspondiente. Se añaden dos nuevas plataformas compatibles:
  ...
  - **Coros y Wahoo:** estos dispositivos exportan en formato FIT estándar, que ya soportaba TrailStats. Ahora se mencionan explícitamente en el área de carga.
  La zona de carga actualiza su texto para indicar todas las plataformas compatibles.
